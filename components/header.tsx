  ...
  return (
    <header className='px-4 lg:p-6 py-3 space-y-4 sm:space-y-0 sm:flex items-center shadow'>
      ...
      <nav className='sm:ml-auto flex items-center justify-center gap-4 sm:gap-6'>
        <Link className='sm:text-sm font-medium hover:underline underline-offset-4' href='/services'>
          Services
        </Link>
        <Link className='sm:text-sm font-medium hover:underline underline-offset-4' href='/about'>
          About
        </Link>
        <Link className='sm:text-sm font-medium hover:underline underline-offset-4' href='/contact'>
          Contact
        </Link>
      </nav>
    </header>
